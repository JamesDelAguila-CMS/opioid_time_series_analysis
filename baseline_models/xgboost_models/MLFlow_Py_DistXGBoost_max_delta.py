...
train = spark.table("eldb.opioid_SA_LA_hosp_final_tsfresh_and_demos_ohe").where(train_split_sql).drop("bene_id")
test = spark.table("eldb.opioid_SA_LA_hosp_final_tsfresh_and_demos_ohe").where(test_split_sql).drop("bene_id")
input_data_descriptor = 'xgboost_tsfresh_ohe_max_delta_step'
